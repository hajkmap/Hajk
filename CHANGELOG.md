...
- Client: FloodSimulator - New plugin that overlays a rising water surface from Terrain-RGB XYZ tiles. Optional classed depth colors via `depthColors`. [#1273](https://github.com/hajkmap/Hajk/issues/1273)

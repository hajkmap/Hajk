...
- Client: AppModel refactored — split the 1444-line class into 8 focused modules under `appModel/` (urlParamsMerger, configTranslator, backgroundLayers, clickBindings, mapFactory, layerLoader, layerVisibility, pluginManager). No behavior change; all public methods preserved. [commit](https://github.com/hajkmap/Hajk/commit/6d7bf599f38c64afcbf8c7fa6bb49c671a44986c)

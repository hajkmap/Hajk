...
- Client: FloodSimulator - New plugin that overlays a rising water surface from Terrain-RGB XYZ tiles. Optional classed depth colors via `depthColors`. A more-settings dialog lets users change the water-level slider max and the animation duration. [#1273](https://github.com/hajkmap/Hajk/issues/1273)

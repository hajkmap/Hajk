...
1. Regularly rebase your branch from develop. That means that you will incorporate recent changes in develop and your local branch will stay on top of it. **This is the really important part.** You can do it like this: `git fetch && git rebase master`.
...
1. Administrators overlooking the project will get notified when you create your PR, take a look at the code and if everything looks fine merge it into `develop` and delete your feature branch from GitHub. You will still have a copy of your feature branch locally, but it can be safely removed by running `git branch -d three-d-mode`. 

    ...
    proxy: {
      proxy1: {
        options: {
          ...
          router: {
            'localhost/mapservice': 'http://localhost:58292/', // Create a virtual route on 9000 that redirects to IIS' /mapservice. NB: Make sure to have IIS running! //localhost/mapservice must be available.

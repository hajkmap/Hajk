...
var MeasureModel = {
  ...
  removeEditFeature: function() {
    if (
      !this.get("editing") &&
      this.get("drawFeature") &&
      (typeof this.get("drawFeature").getProperties().description ===
        "undefined" ||
  ...
  controlDoubleClickZoom: function(active) {
    var interactions = this.get("olMap")
      .getInteractions()
      .getArray();
    var dblClickZoom = interactions.find(
      interaction => interaction instanceof ol.interaction.DoubleClickZoom
    );

...
var SearchBarView = {
          ...
          <div>
            ...
            >
              {this.state.minimized ? (
                <span>
                  Visa <span className="fa fa-angle-down clickable arrow" />
                </span>
              ) : (
                <span>
                  Dölj <span className="fa fa-angle-up clickable arrow" />
                </span>
              )}
            </div>
          </div>
  ...
  render: function() {
    ...
    const buttonClassName =
      this.state.loading ||
      (showResults && !this.state.loading && shouldRenderSearchResults)
        ? "input-group-addon searchbar-search-button-active"
        : "input-group-addon";

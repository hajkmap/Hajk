        ...
        <div className='panel panel-default kir'>
          <div className='panel-heading'>
            Fastighetsförteckning
            {
              ...
              <button className='btn-info-fir'
                onClick={() => this.setState({ instructionVisible: !this.state.instructionVisible })}>
                <img src={this.props.model.get("infoKnappLogo")} />
              </button> : ""
            }

            <button className={expandButtonClass} onClick={() => this.setState({ visible: !this.state.visible })} />
          ...
          <div className={ this.state.visible ? "panel-body" : "panel-body hidden" }>
            <fieldset>
              ...
              <input type="checkbox" id="samfallighet" defaultChecked={this.state.samfallighet} onChange={this.optionChanged} />
              <label htmlFor="samfallighet">Samfälligheter</label><br />

              <input id="ga" type="checkbox" defaultChecked={this.state.ga} onChange={this.optionChanged} />
              <label htmlFor="ga">Gemensamhetsanläggningar</label><br />

              <input id="rattighet" type="checkbox" defaultChecked={this.state.rattighet} onChange={this.optionChanged} />
              <label htmlFor="rattighet">Rättigheter</label><br />

              <input id="persnr" type="checkbox" defaultChecked={this.state.persnr} onChange={this.optionChanged} />
              <label htmlFor="persnr">Personnummer</label><br />

              <input id="taxerad_agare" type="checkbox" defaultChecked={this.state.taxerad_agare} onChange={this.optionChanged} />
...

          {
            ...
            <button className='btn btn-default fir-icon-button' onClick={this.exportToEcxel}>
              <i className='excel' />Skapa fastighetsförteckning
            </button> : ""
          }
          ...
          {
            this.props.model.get('url') ? <a href={this.props.model.get('url')} target="_blank">Ladda ner</a> : ""
          }
        </div>
    );
  }

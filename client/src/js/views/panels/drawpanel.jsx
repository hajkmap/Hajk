...
var DrawPanelView = {
  ...
  abort: function() {
    this.props.model.abort();
    $(
      "#Point, #Circle, #Text, #Polygon, #LineString, #move, #edit, #delete, #Box"
  ...
  activateDrawTool: function(type) {
    ...
    $(
      "#Circle, #Point, #Text, #Polygon, #LineString, #move, #edit, #delete, #Box"
    ).removeClass("selected");
  ...
  renderSymbology: function(type) {
    ...
    function renderPointSettings() {
      switch (this.state.pointSettings) {
        ...
        case "symbol":
          return (
            <div className="point-marker-img">{renderIcons.call(this)}</div>
          );
      }
    }
        ...
        return (
          <div>
            ...
            <select
              ...
              onChange={update.bind(this, "setFontSize", "fontSize")}
            >
            ...
            <ColorPicker
              ...
              onChange={this.props.model.setFontBackColor.bind(
                this.props.model
              )}
            />
          </div>
        ...
        return (
          <div>
            ...
            <select
              ...
              onChange={update.bind(this, "setLineWidth", "lineWidth")}
            >
            ...
            <select
              ...
              onChange={update.bind(this, "setLineStyle", "lineStyle")}
            >
        ...
        return (
          <div>
            ...
            <input
              ...
              onChange={update.bind(this, "setCircleRadius", "circleRadius")}
            />
            <div>Linjefärg</div>
            <ColorPicker
              model={this.props.model}
              property="circleLineColor"
              onChange={this.props.model.setCircleLineColor.bind(
                this.props.model
              )}
            />
            ...
            <ColorPicker
              ...
              onChange={this.props.model.setCircleFillColor.bind(
                this.props.model
              )}
            />
            <div>Opacitet</div>
        ...
        return (
          <div>
            ...
            <ColorPicker
              ...
              onChange={this.props.model.setPolygonLineColor.bind(
                this.props.model
              )}
            />
            <div>Fyllnadsfärg</div>
            <ColorPicker
              ...
              onChange={this.props.model.setPolygonFillColor.bind(
                this.props.model
              )}
            />
            <div>Opacitet</div>
        ...
        return (
          <div>
            ...
            <select
              ...
              onChange={update.bind(this, "setBoxLineWidth", "boxLineWidth")}
            >
              <option value="1">Tunn</option>
              <option value="3">Normal</option>
              <option value="5">Tjock</option>
            ...
            <select
              ...
              onChange={update.bind(this, "setBoxLineStyle", "boxLineStyle")}
            >
              <option value="solid">Heldragen</option>
              <option value="dash">Streckad</option>
              <option value="dot">Punktad</option>
  ...
  renderImport: function(visible) {
    function upload() {
      this.refs.uploadIframe.addEventListener("load", () => {
        this.props.model.importDrawLayer(
          this.refs.uploadIframe.contentDocument
        );
      });
    }
    ...
    if (url === "NO_FEATURES") {
      ...
      return (
        <div>
          ...
          <p>
            Exportfilen är av typen .kml och kan vid ett senare tillfälle
            importeras i kartan. Detta kan vara användbart om du vill dela med
            dig av det du ritat eller vill öppna det vid ett senare tillfälle.
        ...
        <div className="draw-tools">
          <div id="labels">
            <input
              ...
              checked={showLabels}
            />
            <label htmlFor="labels-checkbox" id="drawLabel">
              Visa areal, längd eller koordinater på ritade objekt
            </label>
          </div>
          <ul>
            <li id="Text" onClick={this.activateDrawTool.bind(this, "Text")}>
              <i className="fa fa-font fa-0" /> <span>Skriv text</span>
            </li>
            <li id="Point" onClick={this.activateDrawTool.bind(this, "Point")}>
              <i className="fa fa-circle fa-0" /> <span>Rita punkt</span>
            </li>
            <li
              id="Circle"
              onClick={this.activateDrawTool.bind(this, "Circle")}
            >
              <i className="iconmoon-punkt" /> <span>Rita cirkel</span>
            </li>
            <li
              id="LineString"
              onClick={this.activateDrawTool.bind(this, "LineString")}
            >
              <i className="iconmoon-linje" /> <span>Rita linje</span>
            </li>
            <li
              id="Polygon"
              onClick={this.activateDrawTool.bind(this, "Polygon")}
            >
              <i className="iconmoon-yta" /> <span>Rita yta</span>
            </li>
            <li id="Box" onClick={this.activateDrawTool.bind(this, "Box")}>
              <i className="fa fa-crop fa-0" /> <span>Rita ruta</span>
            </li>
            <li id="move" onClick={this.activateMoveTool}>
              <i className="fa fa-arrows fa-0" /> <span>Flytta objekt</span>
            </li>
            <li id="edit" onClick={this.activateEditTool}>
              <i className="fa fa-edit fa-0" /> <span>Ändra objekt</span>
            </li>
            <li id="delete" onClick={this.activateRemovalTool}>
              <i className="fa fa-eraser fa-0" /> <span>Radera objekt</span>
            </li>
            <li id="clear" onClick={this.alertClear}>
              <i className="fa fa-trash fa-0" /> <span>Rensa allt</span>
            </li>
            <li id="clear" onClick={this.import}>
              <i className="fa fa-file-o fa-0" /> <span>Importera</span>
            </li>
            <li id="clear" onClick={this.export}>
              <i className="fa fa-save fa-0" /> <span>Exportera</span>
            </li>

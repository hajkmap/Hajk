        ...
        <div className="panel-content">
          <div className="panel panel-default">
            ...
            <div className="panel-body">
              <button
                onClick={() => this.props.model.turnOnGPSClicked()}
          ...
          <div className="panel panel-default">
            ...
            <div className="panel-body">
              <div className="btn-group">
                <button
                  className="btn btn-default"
                  onClick={() => this.props.model.setTravelMode("walking")}
                >
                  <img src="/assets/icons/gaRouting.png" />
                </button>
                <button
                  className="btn btn-default"
                  onClick={() => this.props.model.setTravelMode("driving")}
                >
                  <img src="/assets/icons/koraRouting.png" />
                </button>
                <button
                  className="btn btn-default"
                  onClick={() => this.props.model.setTravelMode("bicycling")}
                >
                  <img src="/assets/icons/cyklaRouting.png" />
                </button>
                <button
                  className="btn btn-default"
                  onClick={() => this.props.model.setTravelMode("transit")}
                >
          ...
          <div className="panel panel-default-transparent">
            <button
              onClick={() => this.props.model.activateRoutingMode()}
              className="btn btn-primary"
              id="startBtn"
            >
              Sök resa
            ...
            &nbsp;
            <button
              onClick={() => this.props.model.deleteLayers()}
              className="btn btn-default"
              id="startBtn"
            >
              Rensa

...
var ExportPdfSettings = React.createClass({
    ...
    getPaperMeasures: function () {
        ...
        if (this.props.model.get("layout") == 2) {
            console.log("layout is ", this.props.model.get("layout"));
            ...
            <div className='export-settings'>
                ...
                <div className='panel panel-default'>
                    ...
                    <div className='panel-body'>
                        ...
                        <input type='text' onChange={this.setManualScale} value={this.state.manualScale}/>}
                    </div>
                </div>
                <div className='panel panel-default'>
            ...
            <div>
                ...
                <div className='btn-group'>
                    {activeFormats.map((format, i) =>
                        <button key={i} onClick={() => this.activateTool(format)} type='button'

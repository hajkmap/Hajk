...
var AttributeEditor = React.createClass({
  ...
  setChanged: function() {
    if (
      this.props.model.get("editFeature").modification !== "added" &&
...
var EditPanelView = {
  ...
  render: function() {
    ...
    options = () => {
      return this.props.model.get("sources").map((source, i) => {
        var id = "edit-layer-" + i;
        return (
      ...
      <div>
        ...
        >
          <div className="edit-tools">
            <div className="loading-bar">{loader}</div>
            <Toolbar
              ref="toolbar"
              ...
              panel={this}
            />
            <ul className="edit-layers">{options()}</ul>
            <AttributeEditor
              ref="attributeEditor"

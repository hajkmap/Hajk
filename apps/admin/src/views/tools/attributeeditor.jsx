    ...
    return (
      <div>
        <form>
          ...
          <div>
            <label htmlFor="winwidth">
              Fönsterbredd{" "}
              <i
                className="fa fa-question-circle"
                data-toggle="tooltip"
                title="Bredd i pixlar på verktygets fönster. Anges som ett numeriskt värde."
              />
            </label>
            <input
              id="winwidth"
              ...
              value={this.state.winwidth}
            />
          </div>
          <div>
            <label htmlFor="winheight">
              Fönsterhöjd{" "}
              <i
                className="fa fa-question-circle"
                data-toggle="tooltip"
                title="Höjd i pixlar på verktygets fönster."
              />
            </label>
            <input
              id="winheight"

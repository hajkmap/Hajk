...
export default express
  ...
  // Mount documenthandler before restrictAdmin so client-facing GET endpoints
  // (/load/:name, /load/:folder/:name, /folders, etc.) remain publicly accessible.
  // Write operations inside documentHandlerRouter carry their own restrictAdmin guards.
  .use("/:toolId/documenthandler", documentHandlerRouter)

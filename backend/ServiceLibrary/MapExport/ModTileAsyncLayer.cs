...
namespace SharpMap.Layers
{
    ...
    public class ModTileAsyncLayer : ModTileLayer, ITileAsyncLayer
    {
        ...
        public ModTileAsyncLayer(ITileSource tileSource, string layerName)
        ...
        public ModTileAsyncLayer(ITileSource tileSource, string layerName, Color transparentColor, bool showErrorInTile)
        ...
        public ModTileAsyncLayer(ITileSource tileSource, string layerName, Color transparentColor, bool showErrorInTile, string fileCacheDir)
        ...
        public ModTileAsyncLayer(ITileSource tileSource, string layerName, Color transparentColor, bool showErrorInTile, FileCache fileCache, ImageFormat imgFormat)
        ...
        private bool GetTileOnThread(CancellationToken cancelToken, ITileSource tileSource, TileInfo tileInfo, MemoryCache<Bitmap> bitmaps, bool retry)
        {
            byte[] bytes;
            try
            {
            ...
            catch (WebException ex)
            {
                ...
                if (retry)
                {
                    return GetTileOnThread(cancelToken, tileSource, tileInfo, bitmaps, false);
                }
                else
                {
                    if (_showErrorInTile)

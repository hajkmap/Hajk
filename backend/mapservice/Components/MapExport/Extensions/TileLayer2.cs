...
namespace MapService.Components.MapExport.Extentions
{
    ...
    ///</summary>
    [Serializable]
    public class TileLayer2 : SharpMap.Layers.Layer, System.Runtime.Serialization.IDeserializationCallback
    {
        private static readonly ILog Logger = LogManager.GetLogger<TileLayer2>();
        ...
        public TileLayer2(ITileSource tileSource, string layerName)
        ...
        public TileLayer2(ITileSource tileSource, string layerName, Color transparentColor, bool showErrorInTile)
        ...
        public TileLayer2(ITileSource tileSource, string layerName, Color transparentColor, bool showErrorInTile, string fileCacheDir)
        {
            _source = tileSource;
            LayerName = layerName;
        ...
        public TileLayer2(ITileSource tileSource, string layerName, Color transparentColor, bool showErrorInTile, FileCache fileCache, ImageFormat imgFormat)
        {
            _source = tileSource;
            LayerName = layerName;
            _transparentColor = transparentColor;

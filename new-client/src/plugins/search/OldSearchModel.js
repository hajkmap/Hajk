...
class OldSearchModel {
  /**
   * NB: THIS CLASS IS OBSOLETE AND THE ONLY REASON IT'S HERE IS THAT
   * THIS SEARCH COMPONENT USES THE OLD SEARCH MODEL (I.E. THIS SEARCH MODEL).
   *
   * ALL NEW DEVELOPMENT TAKES PLACE IN src/models/SearchModel.js.
   *
   * @memberof OldSearchModel
   */
  options;

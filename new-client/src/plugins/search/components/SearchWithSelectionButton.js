...
class SearchWithSelectionButton extends React.Component {
  state = {
    active: false
  };
          ...
          <Button
            ...
            onClick={() => {
              this.setState(
                ...
                () => {
                  this.props.model.selectGeometriesForSpatialSearch(
                    this.state.active
                  );

                  /*this.props.model.toggleDraw(
                    this.state.active,
                    { freehand: true, type: "Circle" },
                    { useSearchWithinSources: true },
                    featureCollections => {
                      this.setState({
                        active: false
                      });
                      this.props.onSearchWithin(
...
export default withStyles(styles)(SearchWithSelectionButton);

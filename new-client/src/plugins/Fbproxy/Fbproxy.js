// class Fbproxy extends React.PureComponent {
...
//     this.fbproxyModel = new FbproxyModel({
...
//         type="Fbproxy" // Unique name - each plugin needs one. Upper-case first letter, must be valid JS variable name
//         custom={{
...
//             },
//           ],
//           height: "dynamic", // Custom height/width etc | Use "auto" for automatic or leave undefined
//           width: 400,
//         }}
//       >
...
//           model={this.fbproxyModel} // We can supply our model
...
// import FbproxyModel from "./FbproxyModel";
...
import FBProxyModel from "./FbproxyModel";
import FBProxyView from "./FbproxyView";
...
function Fbproxy(props) {
  ...
  const [fbproxyModel] = React.useState(
    () =>
      new FBProxyModel({
  ...
  return (
    ...
    >
      ...
      <FBProxyView
        // Here we send some props to the plugin's View.
        // Make sure to ONLY include props that are ACTUALLY USED in the View.
        model={fbproxyModel} // We can supply our model

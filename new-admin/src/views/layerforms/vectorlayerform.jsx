...
class VectorLayerForm extends Component {
  ...
  describeLayer(layer) {
    this.props.model.getWFSLayerDescription(this.state.url, layer.name, layerDescription => {
      ...
      return this.state.capabilities.map((layer, i) => {
        ...
        return (
          <li key={i}>
            ...
            <i className={classNames} onClick={(e) => this.describeLayer(layer)} />
          </li>
        );
      });
    } else {
      ...
      <fieldset>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              ...
              this.setState({caption: v}, () => this.validateField('caption'));
            }}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              const v = e.target.value;
              this.setState({symbolXOffset: v}, () => this.validateField('symbolXOffset'));
            }}
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              const v = e.target.value;
              this.setState({symbolYOffset: v}, () => this.validateField('symbolYOffset'));
            }}
          />
        </div>
        <div>
          ...
          <select
            ...
            onChange={(e) => { this.setPointSize(e); }}>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              const v = e.target.value;
              this.setState({projection: v}, () => this.validateField('projection'));
            }}
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              const v = e.target.value;
              this.setState({opacity: v}, () => this.validateField('opacity'));
            }}
          />
        </div>
        <div>

...
class ArcGISLayerForm extends Component {
  ...
  appendLayer(checked, layer) {
    ...
    if (checked === true) {
      ...
      this.setState({
        addedLayers: this.state.addedLayers.filter(addedLayer =>
      ...
      <fieldset>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => {              
              ...
              this.setState({caption: v}, () => this.validateField('caption', v));
            }}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => {              
              const v = e.target.value;
              this.setState({extent: v}, () => this.validateField('extent', v));
            }}
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) => {              
              const v = e.target.value;
              this.setState({opacity: v}, () => this.validateField('opacity', v));
            }}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => {              
              const v = e.target.value;
              this.setState({attribution: v}, () => this.validateField('attribution', v));              
            }}
